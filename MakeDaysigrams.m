...
exportDir = '\\ROOT\projects\GSA_Daysimeter\GSA US Embassy\Riga\Daysimeter_Data\daysigrams';
...
for iObj = 1:n
    ...
    titleText = {'GSA - US Embassy in Riga';['ID: ',thisObj.ID,', Device SN: ',num2str(thisObj.SerialNumber)]};
